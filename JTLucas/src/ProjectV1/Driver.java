 ...
 * Driver.java
 *
 * Created on Feb 12, 2009, 3:33:30 PM
 */
...
class Resizer extends MouseAdapter {
    ...
    public void mouseDragged(MouseEvent e) {
        if(dragging) {
            ...
            if(!JTL_Resizing.ResizingMax( p , (Object) component)){
                return;
            }

            Rectangle r = component.rect;

            if(!JTL_Resizing.ResizingMin( p , (Object) component.rect)){
                return;
            }
    ...
    public void mouseMoved(MouseEvent e) {
        Point p = e.getPoint();
        //System.out.println(isOverRect(p));
        if(!isOverRect(p)) {
            if(component.getCursor() != Cursor.getDefaultCursor()) {
    ...
    private int getOutcode(Point p) {
        ...
        //Rectangle r2 = (Rectangle)component.rect2.clone();
        r.grow(-PROX_DIST, -PROX_DIST);
        //r2.grow(-PROX_DIST, -PROX_DIST);
        return r.outcode(p.x, p.y); //| r2.outcode(p.x,p.y);
    }
    ...
    private boolean isOverRect(Point p) {
        ...
        r.grow(PROX_DIST, PROX_DIST);
        //r2.grow(PROX_DIST, PROX_DIST);
        return r.contains(p); //| r2.contains(p);
    }
}

  ...
  private void initComponents() {
    ...
    private void jbtnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnStartActionPerformed
      ...
      for ( int k = 1 ; k <= nRepetitions ; k++ ) {
        Thread thread = new Thread( new Start_v3(this, k*nRepetitions) );
        thread.start();

//        System.err.println( "   Returned...");
//        jbrProg.setValue(k*10);
//        System.err.println( "      Returned, point #2...");
      }
...
class Start_v3 implements Runnable {
  ProgressBar theApp ;
  int progressBarValue ;

  public Start_v3(ProgressBar theApp, int pbv) {
    this.theApp = theApp ;
    progressBarValue = pbv;
  }

  public void run() {
    simulate() ;
    theApp.setProgressBarValue( progressBarValue );
  }
